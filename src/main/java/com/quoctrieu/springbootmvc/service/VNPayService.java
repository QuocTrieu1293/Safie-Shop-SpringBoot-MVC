...
public class VNPayService {
    ...
    public String generateVNPayURL(double amountDouble, String paymentRef, String ip, long orderId)
        ...
        Calendar cld = Calendar.getInstance(TimeZone.getTimeZone(ZoneId.of("Asia/Bangkok")));
